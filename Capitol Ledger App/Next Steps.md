...
Current September 13 handoff: exact non-production source candidate `92b61b970423ce33dc32f6a2f0a9b72a6d3e2e86` remains isolated and unmerged on `codex/sept12-privacy-neon-candidate`. Preparation-packet checkpoint `69040c5` is pushed in PR #8; CI #320 and the matching Preview pass. Email configuration and Neon cleanup are complete for their approved scopes; unchanged production source remains `7ec68bc`. The exact [five-migration promotion packet](../docs/production-five-migration-promotion-packet-2026-09-13.md), guarded SQL, [privacy single-owner draft](../docs/privacy-operations-single-owner-contingency-2026-09-13.md), and [static provider/logging audit](../docs/provider-logging-static-audit-2026-09-13.md) are prepared. They authorize no external action. The audit found P1 Weekly Brief recipient-level response exposure and raw Stripe provider-error propagation; any fix changes the source candidate and requires refreeze/reconciliation. Apple Support still has not replied and Tyler plans to call September 14, so keep the T04 signing/device freeze intact. While waiting, finish packet child-readiness review, decide the P1 remediation boundary, review privacy operations decisions, or continue local screenshot/App Privacy/Daily Brief preparation and the official verifier-fix watch. Read the [September 13 handoff](../docs/eod-handoff-2026-09-13.md) and [current timeline](../docs/project-timeline.md) before acting. Keep PR #8 unmerged and privacy intake disabled. October 30 remains low-confidence/materially at risk; no database migration, candidate deployment, activation, test message, destructive QA, App Store change, signing, upload, distribution, submission, or release is authorized by this handoff.
...
6. Confirm the privacy policy, support URL, data retention, and account-deletion evidence for Apple review. The current candidate adds App Store server state and privacy-request intake above the September 11 production baseline, so every later drill or action must use the exact five-item order in the [September 13 promotion packet](../docs/production-five-migration-promotion-packet-2026-09-13.md). Follow the separately gated approval packet for future deployment, live schema/FK/Apple-ownership inspection, protected cleanup-task scheduling/monitoring/retries/completed-job erasure, disposable-account plus Team-member/legacy-Stripe cleanup QA, physical-device local/session clearing, backup/PITR tombstone policy, and Apple/Stripe/Sentry/email/official-message retention/removal procedures.
...
- T01 is complete at production source `7ec68bc`, and T02 is complete for new Sentry events under its recorded scope. The frozen graph is advisory-clean, but T03 is high/open because Apple issue #447 affects the enabled OCSP path through end-of-life `jsrsasign@11.1.5`. Current source candidate `92b61b9` plus preparation-packet checkpoint `69040c5` have passing exact-head CI #320, a matching Vercel Preview, and privacy-fallback gate-off smoke. The five-migration packet, privacy single-owner draft, and static provider/logging audit are prepared above that source boundary. T04 is blocked pending Apple Developer Support; preserve the signing freeze and present one exact action for Tyler's approval only after a reply or call guidance is inspected. T05–T11 and every approval/deferred-scope item are carried in the current timeline and September 13 handoff. Corrected-wordmark listing screenshot recapture remains under T09.
