...
Superseding September 14 next step: keep every privacy and App Store processing gate off, preserve the T04 signing/device freeze while Apple Support is pending, and advance T09 locally. PR #13 merged the exact-opt-in aggregate privacy queue monitor into `main` at `ffe994e87f8afbe8882f4fd17a6ecff95217f52f`; all checks, the Ready production deployment, and targeted gate-off smoke passed. The [September 14 owner policy](../docs/privacy-operations-policy-2026-09-14.md) now selects the private-register boundary, twice-business-day review windows, single-owner pause rule, identity escalation, and retention worksheet. Next, implement and validate the missing operator lifecycle against ephemeral PostgreSQL with synthetic identities only. No production monitor read, scheduler, retention run, intake, deletion, or App Store activation is authorized. Production Batch A, PR #8, PR #12, and PR #13 are complete; the dated September 13 instructions below are historical where they say those actions remain pending. Use the [September 14 task-ledger reconciliation](../docs/project-timeline.md#september-14-superseding-reconciliation).
