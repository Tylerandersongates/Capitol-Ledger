...
const defaultBackground =
  "bg-[linear-gradient(180deg,#041a34_0%,#06152c_44%,#030d1f_100%)]";
...
export function MobileShell({
  ambientClassName = "bg-[radial-gradient(circle_at_16%_8%,rgba(83,171,255,0.26),transparent_34%),radial-gradient(circle_at_84%_5%,rgba(255,182,46,0.2),transparent_30%)]",
