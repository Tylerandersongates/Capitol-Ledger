...
export function SubscriptionBadge() {
  ...
  return (
    <div className="mt-3 inline-flex max-w-full items-center gap-2 truncate rounded-full border border-rust/35 bg-rust/10 px-3 py-1 text-[12px] font-medium text-[#ffb12b]">
