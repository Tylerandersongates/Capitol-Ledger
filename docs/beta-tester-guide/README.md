# Capitol Ledger First-Round Beta Tester Guide

## What Capitol Ledger Is

Capitol Ledger is a mobile-first civic tracking app for people who want to follow bills, representatives, votes, alerts, and their own civic engagement without bouncing between scattered government sites and news feeds.

I created Capitol Ledger because civic information is too fragmented for regular people to use consistently. The goal is to make it easier to know what is happening, save what matters, contact the right officials, and build the habit of civic participation without needing to be a policy expert.
...
Use Capitol Ledger like you would use a real civic companion app. Do not just click through screens. Try to complete small real-world tasks:
...
Use the feedback reporting inside Capitol Ledger whenever possible. This keeps tester notes in the beta review queue instead of scattering them across texts, emails, or screenshots.
