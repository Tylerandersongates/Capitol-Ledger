...
def configure_document(doc):
    ...
    header.text = "Capitol Ledger Beta Tester Guide"
...
def add_title_block(doc):
    ...
    run = title.add_run("Capitol Ledger First-Round Beta Tester Guide")
...
def build_docx():
    ...
    doc.core_properties.title = "Capitol Ledger First-Round Beta Tester Guide"
    doc.core_properties.subject = "Editable beta tester guide"
    doc.core_properties.keywords = "Capitol Ledger, beta testing, civic app"
    add_title_block(doc)
