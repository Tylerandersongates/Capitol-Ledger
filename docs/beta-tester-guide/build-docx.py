...
def configure_document(doc):
    ...
    header.text = "CapitolWonk Beta Tester Guide"
...
def add_title_block(doc):
    ...
    run = title.add_run("CapitolWonk First-Round Beta Tester Guide")
...
def build_docx():
    ...
    doc.core_properties.title = "CapitolWonk First-Round Beta Tester Guide"
    doc.core_properties.subject = "Editable beta tester guide"
    doc.core_properties.keywords = "CapitolWonk, beta testing, civic app"
    add_title_block(doc)
