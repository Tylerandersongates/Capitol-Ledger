...
> September 15 continuity note: the September 13 PR #8/Batch A no-go and replacement-child instructions below are historical. Batch A and PR #8 completed September 14. The [September 14 handoff](eod-handoff-2026-09-14.md) and [September 15 read-only evidence](privacy-request-operator-read-only-evidence-2026-09-15.md) supersede that old next-task/resume path; do not recreate the child, repeat the five migrations, or restart the already completed ambient preflight. Carry the Standing Rules above into the next dated EOD.

> September 14 continuation addendum: Production Batch A completed successfully, PR #8 merged the matching default-off privacy/deletion source at `dca8330e012f723ecd77f2756a865e907c0fa553`, and PR #12 merged fail-closed App Store verifier containment at `4836e3e48d95d677f8b64713a7f8af62204ea631`. GitHub checks and the matching Vercel production deployments passed; `4836e3e` deployment `9F3k4yumJTfqDQtEBcAz1bZ6qgnr` is Ready. All privacy, deletion, retention, App Store verification, and Notifications V2 switches remain off. T04 remains frozen pending Apple Support. Apple-independent work continued on `codex/privacy-operations-monitor` with a local exact-opt-in, aggregate-only queue monitor; it has not been deployed, scheduled, configured, or run against production. The September 13 boundary below remains historical where this addendum supersedes it.
...
## Next Safest Task After This Preparation — historical September 13 plan
...
## Resume Prompt — archived September 13 version
