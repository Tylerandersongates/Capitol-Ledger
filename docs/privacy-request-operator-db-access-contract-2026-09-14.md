...
PR #23 deployed the [function-boundary packet](privacy-request-operator-function-boundary-2026-09-14.md), PR #24 deployed its [atomic migration/ACL review](privacy-request-operator-function-migration-review-2026-09-14.md), and PR #25 deployed the [inert role-bootstrap review](privacy-request-operator-role-bootstrap-review-2026-09-14.md), all source-only and unexecuted. The next local [ambient-privilege preflight review](privacy-request-operator-ambient-privilege-preflight-review-2026-09-14.md) prepares only a guarded aggregate read in ephemeral PostgreSQL. It does not authorize production target inspection, shared-ACL remediation, production role creation, network origin, credential issuance/expiry/revocation, migration execution, connection bootstrap, shell binding, or live proof; those remain approval-gated.
