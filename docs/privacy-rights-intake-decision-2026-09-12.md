...
| Source/schema implementation | Frozen at `92b61b970423ce33dc32f6a2f0a9b72a6d3e2e86`; pushed in PR #8 and remotely verified by CI #312, a matching Ready Preview, and anonymous gate-off smoke through documentation checkpoint `6d6a8aa`; not merged, production-deployed, migrated, configured, or activated |
