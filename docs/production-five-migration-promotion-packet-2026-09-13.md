...
Status: **documentation and read-only verification preparation only; production migration is not approved and is not ready for approval.** Exact source candidate `92b61b970423ce33dc32f6a2f0a9b72a6d3e2e86` remains isolated and unmerged on `codex/sept12-privacy-neon-candidate`. Live September 13 verification found documentation/SQL checkpoint `0c09abc0523e2f4de16f55f4d6d2465d27f4abfa` synchronized at the open, unmerged [PR #8](https://github.com/Tylerandersongates/Capitol-Ledger/pull/8) head; exact-head [CI #321](https://github.com/Tylerandersongates/Capitol-Ledger/actions/runs/34780116093) passed and the matching [Vercel Preview](https://vercel.com/capitolwonkce/project-qosv1/7d1i8rinVS8iUhUTPUyba4DMwUfy) reached Ready. Production remains `main` at `7ec68bcf142d6defe865c12959b0f9a84fce72d5`. The local refinements in this packet and its SQL companions are uncommitted review material and are not part of that verified remote checkpoint.
...
| Verified remote documentation/SQL checkpoint | `0c09abc0523e2f4de16f55f4d6d2465d27f4abfa` |
...
1. **Exact packet checkpoint:** independently review the local packet and both SQL companions, recompute their hashes, then create a documentation-only branch checkpoint and rerun the proportionate exact-head checks. The verified remote `0c09abc` packet/SQL copies do not contain every local hardening change recorded here. Do not use either mixed revision, an untracked file, or a dirty/detached checkout for an isolated or production action.
