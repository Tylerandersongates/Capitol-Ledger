// DER certificates published under "Apple Root Certificates" at
// https://www.apple.com/certificateauthority/. Keep this trust set aligned with
// Apple's PKI page when the App Store server library is upgraded.
const appleRootCertificateBase64 = [
...
export function getAppleRootCertificates() {
  return appleRootCertificateBase64.map((certificate) => Buffer.from(certificate.replace(/\s/g, ""), "base64"));
}
