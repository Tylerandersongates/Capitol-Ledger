...
export const subscriptionPlans: Record<SubscriptionPlanId, SubscriptionPlanDetails> = {
  ...
  team: {
    name: "Civic Team",
    description: "Shared civic dashboards",
    demoUseCase: "Show the organization mode for campaigns, nonprofits, advocacy teams, and civic groups.",
    pricing: {
      monthly: "$5.99",
      annual: "$59.99",
      unit: "/ seat"
    },
    highlights: ["Team dashboards", "Shared watchlists", "Exportable reports", "Multi-seat civic workspace"],
    limits: ["Team billing and invite flows still demo-mode only"]
  }
};
